...
SQLITE_API void sqlite3_result_text(sqlite3_context*, const char*, int,
                                    void (*)(void*));
SQLITE_API void sqlite3_result_text64(sqlite3_context*, const char* z,
                                      sqlite3_uint64 n, void (*)(void*),
                                      unsigned char encoding);
...
*/
SQLITE_API int sqlite3changegroup_change_begin(sqlite3_changegroup*, int eOp,
                                               const char* zTab, int bIndirect,
                                               char** pzErr);
...
*/
SQLITE_API int sqlite3changegroup_change_int64(sqlite3_changegroup*, int bNew,
                                               int iCol, sqlite3_int64 iVal);
...
** instead of a 64-bit integer.
*/
SQLITE_API int sqlite3changegroup_change_double(sqlite3_changegroup*, int, int,
                                                double);
...
** be nul-terminated.
*/
SQLITE_API int sqlite3changegroup_change_text(sqlite3_changegroup*, int, int,
                                              const char* pVal, int nVal);
...
*/
SQLITE_API int sqlite3changegroup_change_blob(sqlite3_changegroup*, int, int,
...
*/
SQLITE_API int sqlite3changegroup_change_finish(sqlite3_changegroup*,
                                                int bDiscard, char** pzErr);
