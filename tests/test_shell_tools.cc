...
TEST(BashTest, NotAnObject) {
  ...
  std::string result = ai::call_tool("bash", args);
...
// =============================================================================
// CMD tests (only on Windows; cmd tool is not registered on other platforms)
// =============================================================================
...
TEST(CmdTest, NotAnObject) {
  json args = json::array();
  std::string result = ai::call_tool("cmd", args);
  EXPECT_TRUE(result.find("expected a JSON object") != std::string::npos);
}
...
// =============================================================================
// PowerShell tests (only on Windows; powershell tool is not registered
// elsewhere)
// =============================================================================
...
TEST(PowershellTest, NotAnObject) {
  json args = json::array();
  std::string result = ai::call_tool("powershell", args);
  EXPECT_TRUE(result.find("expected a JSON object") != std::string::npos);
}
